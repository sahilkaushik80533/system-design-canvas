...
export function EvaluationPanel() {
  ...
  const { scores, warnings, recommendations } = evaluationResult;
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-6 border-b border-gray-700 pb-3">
        <h2 className="text-lg font-bold text-white flex items-center gap-2">
          ...
          <span className="ml-2 px-2.5 py-0.5 bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 rounded-full text-sm font-semibold tracking-wide">
            Score: {evaluationResult.overall_score || evaluationResult.score || 0}
          </span>
        </h2>
        <button
      ...
      <div className="mb-6 space-y-3">
        <h3 className="text-sm uppercase tracking-wider font-semibold text-gray-400 mb-3">Scores</h3>
